          ...
          {featuredProjects.map((project) => (
            ...
            >
              <div className="relative group h-[320px] overflow-hidden border hover:border-zinc-700 hover:z-10 transition-all cursor-pointer">
                ...
                <div className="absolute top-4 right-4 z-20 w-9 h-9 rounded-full backdrop-blur-md flex items-center justify-center transition group-hover:scale-110">
                ...
                <div className="absolute inset-x-0 bottom-0 z-10 p-5">
                  <div className="flex items-end justify-between gap-4">
                    ...
                    <div className="flex gap-2 flex-shrink-0">
                      <div className="w-9 h-9 rounded-full flex items-center justify-center transition group-hover:scale-110">
